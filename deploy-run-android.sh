...
adb push -p ./target /data/local/tmp/
...
# run example
# target/aarch64-linux-android/release/icicle-snark
...
adb shell "LD_LIBRARY_PATH=/data/local/tmp/target/aarch64-linux-android/release/deps/icicle/lib /data/local/tmp/target/aarch64-linux-android/release/icicle-snark"